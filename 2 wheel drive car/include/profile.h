...
public:
    ...
    void update()
    {
        ...
        float delta_v = m_acceleration * encoders.loopTime_s();
        ...
        if (this == &rotation) {
            // Set m_speed for the 'forward' instance
            m_current_speed = encoders.robot_omega();  // Example value for 'forward'
        }
        m_position += m_current_speed * encoders.loopTime_s();
